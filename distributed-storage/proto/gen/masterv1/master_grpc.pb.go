...
const (
	MasterService_RegisterNode_FullMethodName      = "/master.v1.MasterService/RegisterNode"
	MasterService_Heartbeat_FullMethodName         = "/master.v1.MasterService/Heartbeat"
	MasterService_ReportChunkStored_FullMethodName = "/master.v1.MasterService/ReportChunkStored"
)
...
//
// MasterService is what storage nodes call on master for registration and reporting.
type MasterServiceClient interface {
	RegisterNode(ctx context.Context, in *RegisterNodeRequest, opts ...grpc.CallOption) (*RegisterNodeResponse, error)
	Heartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*HeartbeatResponse, error)
	ReportChunkStored(ctx context.Context, in *ReportChunkStoredRequest, opts ...grpc.CallOption) (*ReportChunkStoredResponse, error)
}
...
func (c *masterServiceClient) ReportChunkStored(ctx context.Context, in *ReportChunkStoredRequest, opts ...grpc.CallOption) (*ReportChunkStoredResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportChunkStoredResponse)
	err := c.cc.Invoke(ctx, MasterService_ReportChunkStored_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MasterServiceServer interface {
	...
	ReportChunkStored(context.Context, *ReportChunkStoredRequest) (*ReportChunkStoredResponse, error)
...
func (UnimplementedMasterServiceServer) ReportChunkStored(context.Context, *ReportChunkStoredRequest) (*ReportChunkStoredResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportChunkStored not implemented")
}
...
func _MasterService_ReportChunkStored_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportChunkStoredRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterServiceServer).ReportChunkStored(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MasterService_ReportChunkStored_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServiceServer).ReportChunkStored(ctx, req.(*ReportChunkStoredRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MasterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReportChunkStored",
			Handler:    _MasterService_ReportChunkStored_Handler,
		},
	},
